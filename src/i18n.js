...
export const messages = {
  en: {
    ...
    ideas: {
      ...
      remove: 'Remove',
      lockPrompt: 'A private sky. Enter the passcode to open it.',
      passcode: 'Passcode',
      unlock: 'Enter',
      wrong: 'Wrong passcode. Try again.',
      lock: 'Lock',
      loading: 'Opening the sky…',
      error: 'Could not reach the sky. Try again.',
    },
    hero: {
  ...
  ar: {
    ...
    ideas: {
      ...
      remove: 'حذف',
      lockPrompt: 'سماء خاصة. أدخل كلمة المرور للدخول.',
      passcode: 'كلمة المرور',
      unlock: 'دخول',
      wrong: 'كلمة المرور غير صحيحة. حاول مجددًا.',
      lock: 'قفل',
      loading: 'يفتح السماء…',
      error: 'تعذّر الوصول إلى السماء. حاول مجددًا.',
    },
    hero: {
